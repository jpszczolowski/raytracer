...
let quadratic_equation_roots a b c =
  ...
  if delta = 0. then (print_endline "ONE_SOLUTION"; [-. b /. denominator]) else
                     (print_endline "TWO_SOLUTIONS"; [(-. b -. Pervasives.sqrt delta) /. denominator; (-. b +. Pervasives.sqrt delta) /. denominator])
